...
export const useEventos = () => {
     ...
     */
    const loadEventosFuturos = useCallback(async () => {
        const result = await dispatch(getEventosFuturos() as any);
        return result;
    }, [dispatch]);
    ...
    const eventosFuturosManager = {
         ...
         * Carga eventos futuros desde el servidor
         */
        cargarEventosFuturos: async () => {
            return await loadEventosFuturos();
        },
