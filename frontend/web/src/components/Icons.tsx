...
export const TrophyIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M7 4V2C7 1.45 7.45 1 8 1h8c.55 0 1 .45 1 1v2h5v6c0 2.21-1.79 4-4 4h-.5c-.83 1.97-2.54 3.5-4.64 3.91L13 20h2c.55 0 1 .45 1 1s-.45 1-1 1H9c-.55 0-1-.45-1-1s.45-1 1-1h2l.14-1.09C9.04 17.5 7.33 15.97 6.5 14H6c-2.21 0-4-1.79-4-4V4h5zm8 0H9v1h6V4zM4 6v4c0 1.1.9 2 2 2h1.16c.63 1.91 2.28 3.36 4.34 3.77L12 14h.5c2.28 0 4.17-1.57 4.67-3.67L17.5 10H18c1.1 0 2-.9 2-2V6H4z"/>
  </svg>
);

export const GiftIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M20 6h-2.18c.11-.31.18-.65.18-1a2.996 2.996 0 0 0-5.5-1.65l-.5.67-.5-.68C10.96 2.54 10.05 2 9 2 7.34 2 6 3.34 6 5c0 .35.07.69.18 1H4c-1.11 0-2 .89-2 2v4c0 1.11.89 2 2 2h1v5c0 1.11.89 2 2 2h10c1.11 0 2-.89 2-2v-5h1c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zM9 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm6 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM4 8h16v4H4V8zm9 6v5h-2v-5h2z"/>
  </svg>
);
...
export const RocketIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12 2c0 .74.58 2.55.68 3.56L12 8.12 11.32 5.56C11.42 4.55 12 2.74 12 2zm4.24 7.36c-.31 1.26-.54 2.21-.95 3.09-.5 1.07-1.17 1.63-1.87 2.06L12 16l-1.42-1.49c-.7-.43-1.37-.99-1.87-2.06-.41-.88-.64-1.83-.95-3.09L8.5 8h7l-.76 1.36zM16 17.8L12 16l4 1.8zM8 17.8L12 16l-4 1.8zM8.5 8L12 2l3.5 6h-7z"/>
  </svg>
);
