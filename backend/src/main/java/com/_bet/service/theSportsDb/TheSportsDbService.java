...
public class TheSportsDbService {
    ...
    /**
     * Procesa ligas en lotes optimizado, saltando las que ya existen y están
     * actualizadas
     */
    @Transactional
    public void procesarLigasEnLotesOptimizado(List<TheSportDbLeagueDto> ligasDto, int tamanoLote) {
        ...
        for (int i = 0; i < ligasDto.size(); i += tamanoLote) {
            ...
            try {
                ...
                log.info(
                        "Lote {}/{} completado - Procesadas: {}, Omitidas: {}, Total procesadas: {}, Total omitidas: {}",
                        (i / tamanoLote) + 1,
    ...
    /**
     * Sincroniza todas las ligas por deporte usando países disponibles con manejo
     * de rate limiting
     */
    @Async
    @Transactional
    ...
    public void procesarLiga(TheSportDbLeagueDto leagueDto) {
        try {
            ...
            liga.setDescripcion(leagueDto.getStrDescriptionES() != null ? leagueDto.getStrDescriptionES()
                    : leagueDto.getStrDescriptionEN());
    ...
    public void procesarEquipo(TheSportDbTeamDto teamDto) {
        try {
            ...
            equipo.setDescripcion(teamDto.getStrDescriptionES() != null ? teamDto.getStrDescriptionES()
                    : teamDto.getStrDescriptionEN());
                ...
                try {
                    ...
                    try {
                        ...
                        evento.setFechaEvento(
                                LocalDateTime.parse(eventDto.getDateEvent() + " 00:00:00", DATETIME_FORMATTER));
    ...
    /**
     * Sincronización completa inicial (deportes, ligas y equipos) con manejo de
     * rate limiting
     */
    @Async
    @Transactional
    ...
    /**
     * Sincroniza eventos de los próximos 7 días desde hoy para todas las ligas
     * activas
    ...
    /**
     * Método para obtener información de un evento específico por ID desde la base
     * de datos
     */
